...
module.exports = opts => {
  ...
  const questions = file.slice(1, file.length).map(q => Object.assign({}, q, {id: file.indexOf(q)}))
  ...
  return {
    ...
    questions: questions.slice(opts.limit*(opts.page-1), opts.limit*opts.page),
    from: opts.limit*(opts.page-1) + 1,
    to: opts.limit*opts.page
  }
}
